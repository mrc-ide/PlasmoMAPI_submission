...
# sim_false_positives_ecc_regular.R
#
# Author: Bob Verity
# Date: 2020-09-17
#
# Purpose:
# Equivalent to sim_false_positives_ecc_random.R, except nodes are arranged
...
# define parameters
reps <- 1e3
ecc_vec <- c(seq(0.1, 0.9, 0.2), 0.95)
L <- 5
...
ret <- list(which_lower = which_lower,
            ...
            p = p,
            ecc_vec = ecc_vec)
saveRDS(ret, "FigureS2_false_positives_ecc/sim_false_positives_ecc_regular.rds")
